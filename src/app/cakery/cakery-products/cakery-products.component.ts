...
@Component({
  selector: 'app-cakery-products',
  templateUrl: './cakery-products.component.html',
  styleUrls: ['./cakery-products.component.scss']
})
export class CakeryProductsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.filtered = this.cakery_products;
  }

  productFilter(type:any){
    this.filtered = this.cakery_products.filter( product=> product.type == type);
  }
